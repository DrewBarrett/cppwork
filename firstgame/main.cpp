    ...
    while (1) {
        ...
        if (redraw && al_is_event_queue_empty(queue)) {
            ...
            if(title){
                ...
                al_draw_text(font, white, ScreenWidth/2,50,ALLEGRO_ALIGN_CENTRE, "You get a point for winning a match");
                ...
                al_draw_text(font, white, ScreenWidth/2,ScreenHeight/2,ALLEGRO_ALIGN_CENTRE, "You win!");
            }else if(lose){
                al_draw_text(font, white, ScreenWidth/2,ScreenHeight/2,ALLEGRO_ALIGN_CENTRE, "You lose!");
            }else{
                al_clear_to_color(al_map_rgb(0,0,0));
                //char *score = won;
                al_draw_text(font, white, 0 ,0,ALLEGRO_ALIGN_LEFT, "Player score: ");
                al_draw_text(font, white, ScreenWidth,0,ALLEGRO_ALIGN_RIGHT, "Enemy score: ");
